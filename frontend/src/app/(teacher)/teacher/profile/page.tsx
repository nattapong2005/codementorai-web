            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                        ...
                        <div className="md:ml-auto">
                            {!isEditing ? (
                                <button
                                    ...
                                    className="cursor-pointer flex items-center gap-2 px-5 py-2.5 bg-white text-blue-600 font-medium rounded-lg shadow hover:bg-blue-50 transition-all"
                                >
                                    <FaEdit /> แก้ไขข้อมูล
                                </button>
                            ) : (
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className="cursor-pointer flex items-center gap-2 px-4 py-2 bg-white/20 text-white font-medium rounded-lg hover:bg-white/30 transition-all"
                                    >
                                        <FaTimes /> ยกเลิก
                                    </button>
                                    <button
                                        onClick={handleSave}
                                        disabled={isSaving}
                                        className="cursor-pointer flex items-center gap-2 px-4 py-2 bg-white text-blue-600 font-medium rounded-lg shadow hover:bg-blue-50 transition-all disabled:opacity-50"
                                    >
                ...
                <div className="p-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            <label className="flex items-center gap-2 text-sm font-semibold text-gray-600 uppercase tracking-wider">
                                <FaIdCard className="text-purple-500" /> รหัสผู้สอน
                            </label>
